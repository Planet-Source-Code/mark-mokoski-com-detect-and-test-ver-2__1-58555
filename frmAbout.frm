...
Begin VB.Form frmAbout 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Height          =   945
      Left            =   5640
      MouseIcon       =   "frmAbout.frx":1A95
      MousePointer    =   99  'Custom
      Picture         =   "frmAbout.frx":1D9F
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   3360
      Width           =   1260
...
Attribute VB_Exposed = False
    ...
    'Create the Balloon tool tips
    Dim EmailLabeltip              As New clsTooltips
    Dim WebSiteLabelTip            As New clsTooltips
    Dim MarkPicTip                 As New clsTooltips
...
Private Sub emailLabel_Click()
    ...
    ShellExecute hWnd, vbNullString, "mailto:markm@cmtelephone.com?Subject=Questions or Comments on COM Port Detect and Test Application.", vbNullString, vbNullString, vbNormalFocus
...
Private Sub Form_Load()
    ...
    'Make the Balloon ToolTips
    EmailLabeltip.CreateBalloon EmailLabel, "Click to send Email to" + vbCrLf + "Mark Mokoski WA1ZEK / VK2IFH", "Email", tipiconinfo
    WebSiteLabelTip.CreateBalloon websiteLabel, "Click to send Browser to my Web Site", "Web Site", tipiconinfo
    MarkPicTip.CreateBalloon MarkPic, _
    "Click on Picture to goto" & vbCrLf & _
    "my code files on" & vbCrLf & _
    "Planet Source Code", _
    "Goto Code on PSC", 2
